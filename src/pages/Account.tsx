...
export const Account = () => {
  ...
  if (!user) {
    return (
      <div className={`min-h-screen ${darkMode ? "bg-gray-950 text-gray-100" : "bg-white text-black"} flex items-center justify-center`}>
        <div className="text-center">
          ...
          <Link to="/auth" className="px-6 py-3 bg-yellow-600 text-black rounded-lg font-semibold">
            {t('auth.login')}
          </Link>
        </div>
      </div>
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-gray-950 text-gray-100" : "bg-white text-black"} py-12`}>
      <div className="container mx-auto px-4">
        ...
        <div className={`${darkMode ? "bg-gray-900 text-gray-100" : "bg-gray-50 text-black"} p-6 rounded-lg`}>
