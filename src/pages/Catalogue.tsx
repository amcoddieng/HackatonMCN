...
export const Catalogue = () => {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-gray-800 text-gray-100" : "bg-gray-50 text-black"} py-12 transition-all duration-300`}>
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 flex flex-col md:flex-row gap-4">
          <input
            ...
            className={`border ${darkMode ? 'border-gray-600 bg-gray-700 text-gray-100' : 'border-gray-300 bg-white text-black'} rounded-lg py-2 px-4 w-full md:w-1/2 transition-all duration-300 focus:ring-2 focus:ring-yellow-400`}
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {currentArtworks.map((artwork: Artwork) => (
              <a
                ...
                className={`${darkMode ? 'bg-gray-700 hover:border-yellow-600' : 'bg-white hover:border-yellow-500 border-gray-200'} rounded-lg overflow-hidden border transition-all duration-300 hover:shadow-lg hover:scale-105 block`}
              >
                <img
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center gap-4 mt-8">
            <button
              ...
              className={`${darkMode ? 'bg-gray-700 text-gray-100' : 'bg-gray-200 text-black'} px-4 py-2 rounded disabled:opacity-50 transition-all duration-300 hover:shadow-lg`}
            >
              {t('previous')}
            </button>
            <span>
