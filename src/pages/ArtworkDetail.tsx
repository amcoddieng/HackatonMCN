    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-950 text-gray-100' : 'bg-gray-50 text-black'} py-8 px-4 md:px-12`}>
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          <h1 className={`text-3xl md:text-4xl font-bold ${darkMode ? 'text-yellow-400' : 'text-yellow-600'} mb-2`}>
            {artwork.title[lang]}
          </h1>
          <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} mb-4 flex flex-wrap gap-2 md:gap-4`}>
            <span className="flex items-center gap-1">
              <i className="fas fa-calendar-alt"></i> {artwork.period}
            </span>
            <span className="flex items-center gap-1">
              <i className="fas fa-map-marker-alt"></i> {artwork.origin}
            </span>
            <span className="flex items-center gap-1">
              <i className="fas fa-tag"></i> {artwork.category}
            </span>
          </p>
